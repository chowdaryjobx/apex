    ...
    <View style={styles.container}>
        ...
        <View style={styles.headerContent}>
          <View style={styles.headerContent1}>
            <View>
              ...
              <View style={{top: 10}}>
                <Text style={{fontSize: 20, color: '#F26822'}}>
      ...
      <ScrollView
        ...
        <View
          ...
          <Text style={{color: 'gray', paddingVertical: 10, color: '#F26822'}}>
            BUSINESS{' '}
          </Text>
          <View style={{}}>
            <View style={styles.bodyRow}>
          ...
          <View style={{}}>
            <View style={styles.bodyRow}>
              ...
              <TouchableOpacity
                ...
                style={styles.bodyText}>
                <Text style={styles.headingText}>Franchise Opportunity</Text>
              </TouchableOpacity>
            </View>
          </View>
          <View style={{}}>
            <View style={styles.bodyRow}>
              ...
              <TouchableOpacity
                ...
                style={styles.bodyText}>
                <Text style={styles.headingText}>Grievence Cell</Text>
              </TouchableOpacity>
            </View>
          </View>
          {/* <View style={{}}>
          ...
          <View style={{}}>
            <View style={styles.bodyRow}>
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate('CeilingUpgradation');
                }}
                style={styles.bodyText}>

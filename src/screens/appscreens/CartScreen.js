...
function CartScreen({ navigation }) {
    const { user, userData, increaseProducts, decreaseProducts, removeProduct, cartItems, deliverableAddresses, companyName } = React.useContext(DataContext);
            ...
            <View style={{ backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#ccc', paddingLeft: 10, flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }} >
                ...
                <View style={{
                    ...
                    <Text>{cartItems.length}  items,   To Pay :
                        <FontAwesome name="rupee" size={14} color="black" style={{ left: 20 }} >
            ...
            <ScrollView style={{ flex: 1 }} >
                <View style={{ borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#ccc', top: 3, backgroundColor: '#fff', paddingHorizontal: 20, paddingVertical: 5 }} >
                    ...
                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }} >
                        ...
                        }} style={{ borderRadius: 5, margin: 10, flex: 1, borderWidth: 1, borderColor: '#35CBC4', justifyContent: 'center', alignItems: 'center', padding: 5 }} >
                            <Text style={{ fontSize: 12, color: '#35CBC4' }} >SELECT ADDRESS</Text>
                            {user ? <Text style={{ fontSize: 8, color: '#35CBC4' }} >
                                {/* {userData.address} */}
                            </Text> : null}
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => {
                            // user ? navigation.navigate('Address') : navigation.navigate('Login')
                        }} style={{ backgroundColor: '#35CBC4', borderRadius: 5, margin: 10, flex: 1, borderWidth: 1, borderColor: '#ccc', justifyContent: 'center', alignItems: 'center', padding: 5 }} >
                    ...
                    <View style={{ flex: 1, paddingVertical: 5 }} >
                        ...
                        <View style={{ paddingVertical: 10, flexDirection: 'row', justifyContent: 'space-between', paddingBottom: 10 }} >
                            ...
                            <FontAwesome name="rupee" size={16} color='#000' >
                                <Text style={{ color: 'black', fontSize: 18, color: '#000' }} >  {total}.00</Text>
                            </FontAwesome>
                        </View>
                    </View>
                </View>
                <View style={{ paddingHorizontal: 20, paddingVertical: 30 }} >
                    <Text style={{ fontSize: 22, fontWeight: 'bold', fontStyle: 'italic', color: 'gray' }} >{companyName}</Text>
                    <Text style={{ fontSize: 14, fontStyle: 'italic', color: 'gray' }} >your almost there to get your product.</Text>
                </View>
